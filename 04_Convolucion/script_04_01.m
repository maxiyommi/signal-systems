...
subplot(4,1,1)
plot(tX,0.5*x,'b'); xlabel('Tiempo'); ylabel('Se�al anecoica - x(t)'); grid on; ylim([-0.5 0.5])
subplot(4,1,2)
...
subplot(4,1,4)
plot(tYsum,ysum,'r'); xlabel('Tiempo'); ylabel('Salida del sistema + se�al anecoica- y(t)'); grid on; ylim([-0.5 0.5])
